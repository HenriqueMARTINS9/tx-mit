...
export default function Home() {
  return (
    <main className="pb-20">
      <section className="mx-auto max-w-4xl px-6 pb-8 pt-8">
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/75 p-8 shadow-panel backdrop-blur">
          ...
          <div className="relative">
            <div className="mb-5 flex flex-wrap gap-3 text-xs font-medium uppercase tracking-[0.28em] text-cyan-200/85">
